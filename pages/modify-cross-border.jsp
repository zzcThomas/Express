...
<c:if test="${detail.packageIsCrossBorder eq true}">
			...
			<div class="ibox">
				...
				<div class="ibox-content">
					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-2">
							<div class="radio i-checks">
							<label><input type="radio" value="1" name="package_cross_border_unreachable" id="package_cross_border_unreachable"<c:if test="${detail.packageCrossBorderUnreachable eq 1 }">checked=""</c:if>  > <i></i>退回，并承担退回费用 </label>
							</div>
						</div>						
						<div class="col-sm-4 col-md-2">
							<div class="radio i-checks">
							<label><input type="radio" value="2" name="package_cross_border_unreachable" <c:if test="${detail.packageCrossBorderUnreachable eq 2 }">checked=""</c:if>  > <i></i>放弃</label>
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						...
						<c:forEach var="item" items="${packageExpressList}">
   						<div class="col-sm-3 col-md-2">
							<div class="radio i-checks">
							<label><input type="radio" value="${item.id}" name="package_expect_express" <c:if test="${detail.packageExpectExpress.id eq item.id }">checked=""</c:if> <c:if test="${item.id eq 0 or item.id eq 4}">id="package_expect_express"</c:if> /> <i></i>${item.name}</label>
							</div>
						</div>
						</c:forEach>
					</div>
...
var layer_markinfo_index;
 ...
 <c:if test="${detail.packageIsCrossBorder ne true}"> 该页面无法修改 非跨境对公快递</c:if>
</div>
