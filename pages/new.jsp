			...
			<div class="ibox">
				...
				<div class="ibox-content info-card"  id="recv_info">
					...
					<div class="row">
	                    ...
	                    <div class="col-sm-6">
	                    	<select class="form-control m-b province" id="recv_province" name="recv_province" data-first-value=""  data-first-title="省份/自治区">
                            </select>
	                    </div>
	                    <div class="col-sm-6">
	                    	<select class="form-control m-b city" id="recv_city"name="recv_city"  data-first-value=""  data-first-title="城市/地区">
                            </select>
	                    </div>
	                    <div class="col-sm-12">
	                    	<select class="form-control m-b area" id="recv_district" name="recv_district" data-first-value=""  data-first-title="区/县">
                            </select>
	                    </div>
	                    <div class="col-sm-12">
			...
			<div class="ibox">
				...
				<div class="ibox-content info-card"  id="send_info">
					...
					<div class="row">
	                    ...
	                    <div class="col-sm-6">
	                    	<select class="form-control m-b province" id="send_province" name="send_province" data-first-value=""  data-first-title="省份/自治区">
                            </select>
	                    </div>
	                    <div class="col-sm-6">
	                    	<select class="form-control m-b city" id="send_city"name="send_city"  data-first-value=""  data-first-title="城市/地区">
                            </select>
	                    </div>
	                    <div class="col-sm-12">
	                    	<select class="form-control m-b area" id="send_district" name="send_district" data-first-value=""  data-first-title="区/县">
                            </select>
	                    </div>
	                    <div class="col-sm-12">
					...
					<div class="row">
						...
						<c:forEach var="item" items="${packageExpressList}">
   						<div class="col-sm-3 col-md-2">
							<div class="radio i-checks">
							<label><input type="radio" value="${item.id}" name="package_expect_express"  <c:if test="${item.id eq 0 }">id="package_expect_express"</c:if> /> <i></i>${item.name}</label>
							</div>
						</div>
						</c:forEach>
					</div>
        ...
        $(document).ready(function () {
            ...
            $('#submit_btn').click(function(){
            	var check_message = {
        			...
        			"recv_phonenum":["请填写收件人手机号",/^[0-9\(\)+]{1,16}$/,"手机号格式错误"],//数字 可有连字符和加号和括号，不多于16位
